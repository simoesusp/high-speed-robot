...
\hypersetup{
		...
		pdfkeywords={abnt}{latex}{abntex}{abntex2}{trabalho acadêmico}, % TODO colocar as keywords bonitinho!
...
\begin{siglas}
  ...
  \item[SPI] \textit{Serial Peripheral Interface} %% TODO: check it
  \item[USB] \textit{Universal Serial Bus}
  \item[CRC] \textit{Cyclic Redundancy Check}
  \item[GFSK] \textit{Gaussian Frequency Shift Keying} %%TODO: check it
...
\input{../EmbasamentoTeorico/EmbasamentoTeorico.tex}
\input{../Materiais/Materiais.tex}
